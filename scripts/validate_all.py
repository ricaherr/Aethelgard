...
async def main():
    ...
    audit_tasks = [
        ...
        run_audit_module("SPRINT S007", ["python", "-m", "pytest", "tests/test_bootstrap_strategy_ranking.py", "tests/test_strategy_ranker.py", "tests/test_strategy_engine_factory_phase3.py", "tests/test_main_orchestrator_phase4.py", "tests/test_circuit_breaker_phase5.py", "tests/test_executor_circuit_breaker_integration.py", "tests/test_qa_phase_integration.py", "tests/test_strategy_monitor_service.py", "tests/test_strategy_ws.py", "tests/test_degradation_alert_service.py", "-q"], workspace),
