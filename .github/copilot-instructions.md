...
14. **ROADMAP Obligatorio**: SIEMPRE actualizar ROADMAP.md al inicio de cada tarea mayor con el plan de trabajo. Marcar tareas completadas (✅) conforme se finalizan. El ROADMAP debe reflejar en tiempo real qué se hizo y qué falta.
